...
face-saving return before the wedding, and you agree.`,
    ...
    },
    {
      ...
      colour: 0x3498db,
      pos: [10, 0],
      provokes: "Insulting the city or refusing to speak.",
      persona: `You are a friendly local resident. You love talking about the culture, history, and food of your city. You answer in the local language, but you are very patient. You want the player to practice speaking. If they make a mistake, gently encourage them.`,
      mission: {
        title: "Chit Chat",
        brief: "Just say hello and talk about the city.",
        successCriteria: "The player talked to you.",
        reward: 50,
      },
      clue: "The city is beautiful.",
      lesson: [],
    },
  ],
  finale: {
...
const deccanPunePhrases: Phrase[] = [
  { native: "नमस्कार", roman: "Namaskar", en: "Hello" },
  { native: "किती पैसे?", roman: "Kiti paise?", en: "How much?" },
  { native: "मला मदत हवी आहे", roman: "Mala madat havi aahe", en: "I need help" },
  { native: "मला समजत नाही", roman: "Mala samjat nahi", en: "I do not understand" },
  { native: "हळू बोला", roman: "Halu bola", en: "Please say it slowly" },
  { native: "धन्यवाद", roman: "Dhanyawad", en: "Thank you" },
];

export const deccanPune: District = {
  id: "deccan-pune",
  name: "Deccan Pune",
  city: "Pune",
  blurb: "Historic streets, legendary Misal Pav, and a missing scooter.",
  coverImage: "/covers/deccan-pune.jpg",
  language: "mr-IN",
  languageLabel: "Marathi",
  native: "मराठी",
  script: "Devanagari",
  premise: `Prakash Dada's scooter vanished from his misal joint. Talk to the locals to find it.`,
  theme: {
    sky: ["#6CA6CD", "#87CEEB", "#B0E2FF", "#E6E6FA", "#FFF0F5"],
    fog: 0xcccccc,
    fogNear: 50,
    ground: 0xb99a73,
    pavement: 0x8f7d6b,
    ...
    tarmac: 0x5a5652,
    lane: 0xa99b8f,
    buildings: [0xcca87d, 0x9b8b7a, 0x6b4c3a, 0xe0dac9, 0xb99a73, 0x8a7f8c, 0x3a2c22],
    canopies: [0xff4500, 0x8b0000, 0xff8c00],
    leaf: 0x3f8a52,
    trunk: 0x5c4a3e,
    sunColour: 0xffeec8,
    sunIntensity: 2.0,
  ...
  npcs: [
    {
      ...
      colour: 0xcca87d,
      pos: [2, 0],
      persona: "Owner of the famous misal joint.",
      provokes: "Being rude.",
      mission: {
        title: "Buy Misal",
        brief: "Buy misal.",
        successCriteria: "Bought misal.",
        reward: 10,
      },
      clue: "Misal bought.",
    ...
    },
    {
      ...
      colour: 0xe0dac9,
      pos: [5, 4],
      persona: "College student studying nearby.",
      provokes: "Interrupting study.",
      mission: {
        title: "Ask Directions",
        brief: "Ask directions.",
        successCriteria: "Got directions.",
        reward: 15,
      },
      clue: "Directions received.",
      lesson: phrasebookLesson(deccanPunePhrases),
    },
    {
      id: "pune-npc-3",
      ...
      colour: 0xff8c00,
      pos: [-4, 6],
      persona: "Auto driver resting.",
      provokes: "Waking him up roughly.",
      mission: {
        title: "Hire Auto",
        brief: "Hire auto.",
        successCriteria: "Hired auto.",
        reward: 20,
      },
      clue: "Auto hired.",
      lesson: phrasebookLesson(deccanPunePhrases),
    },
    {
      ...
      colour: 0x8a7f8c,
      pos: [8, -3],
      persona: "Bus conductor.",
      provokes: "Not paying fare.",
      mission: {
        title: "Buy Ticket",
        brief: "Buy ticket.",
        successCriteria: "Bought ticket.",
        reward: 30,
      },
      clue: "Ticket bought.",
      lesson: phrasebookLesson(deccanPunePhrases),
  ...
  finale: {
    title: "Scooter Mystery",
    text: "Prakash dada's scooter went missing.",
  },
};
