...
const puraniSadak: DistrictTaskPack = {
  ...
  tasks: [
    ...
    {
      id: "purani-sadak-coffee",
      districtId: "purani-sadak",
      kind: "shop",
      pos: [0, 18],
      title: "Filter Coffee",
      brief: "Order a hot cup of filter coffee from the nearby stall.",
      reward: 150,
      interactLabel: "Order coffee",
      name: "Vendor",
      role: "Coffee Stall",
      speaker: "rohan",
      colour: 0xd35400,
